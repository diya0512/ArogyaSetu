...
export default function Footer() {
  return (
    <footer style={{
      background: "#0a1f3c",
      borderTop: "3px solid #c6902a",
      marginTop: "auto",
    }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2.2fr 1fr 1fr 1.2fr", gap: 48, marginBottom: 40 }}>
          ...
          <div>
            ...
            {services.map(l => (
              <div key={l} style={{ marginBottom: 10 }}>
                <Link href="/" style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", textDecoration: "none", transition: "color 0.15s" }}
          ...
          <div>
            ...
            {helplines.map(h => (
              <div key={h.label} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <a href={`tel:${h.number}`} style={{ fontSize: 15, fontWeight: 700, color: "#c6902a", textDecoration: "none", letterSpacing: "-0.3px" }}>{h.number}</a>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "16px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 20 }}>
            {["Privacy Policy", "Terms of Use", "Accessibility", "RTI"].map(l => (
              <Link key={l} href="/" style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", textDecoration: "none" }}
